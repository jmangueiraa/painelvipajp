...
function ConfiguracoesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="Conectar WhatsApp" description="Conecte sua conta para enviar cobranças automáticas" icon={MessageSquare} color="var(--kpi-emerald)">
        <div className="space-y-1">
          <Label>Instância (Evolution)</Label>
          <Input placeholder="nome-da-instancia" value={whatsappInstance} onChange={(e) => setWhatsappInstance(e.target.value)} />
          <p className="text-xs text-muted-foreground">Usado para vincular sua conta a um provedor de WhatsApp.</p>
        </div>
        <Button className="btn-premium rounded-full" onClick={() => saveSettings.mutate({ whatsapp_instance: whatsappInstance })}>Salvar</Button>
      </SectionCard>
